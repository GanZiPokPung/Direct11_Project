...
bool TextureShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	return InitializeShader(device, hwnd, 
		L"../Project_KSB/Texture.vs", L"../Project_KSB/Texture.ps");
}
...
bool TextureShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX world, XMMATRIX view, XMMATRIX proj, ID3D11ShaderResourceView* texture)
{
...
bool TextureShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsPath, WCHAR* psPath)
{
	// 쉐이더 파일 컴파일
	ID3D10Blob* errorMessage = nullptr;

	ID3D10Blob* vertexShaderBuffer = nullptr;
	if (FAILED(D3DCompileFromFile(vsPath, NULL, NULL, "TextureVertexShader", "vs_5_0",
	...
	if (FAILED(D3DCompileFromFile(psPath, NULL, NULL, "TexturePixelShader", "ps_5_0",
...
void TextureShader::OutputShaderErrorMessage(ID3D10Blob* blob, HWND hwnd, WCHAR* shaderPath)
{
...
bool TextureShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX world, XMMATRIX view, XMMATRIX proj
